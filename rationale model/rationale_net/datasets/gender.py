...
@RegisterDataset('long_gender')
class LongGenderDataset(AbstractDataset):

    def __init__(self, args, word_to_indx, mode, max_length=250, stem='raw_data/long_gender/gender_organized_'):
        #aspect = args.aspect
        self.args= args
        self.name = mode
        ...
        self.name_to_key = {'train':'classtrain_sub', 'dev':'test_sub', 'test':'test_sub'}
        self.class_balance = {}
        ...
        if args.class_balance:
            raise NotImplementedError("Long gender dataset doesn't support balanced sampling!")
